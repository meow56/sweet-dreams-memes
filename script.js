...
function Node(metadata, official) {
  ...
  this.display = function(nodes, i) {
    ...
    newCircle.addEventListener("mouseover", new Function("var newTri = document.createElementNS(\"http://www.w3.org/2000/svg\", \"polygon\"); newTri.setAttributeNS(null, \"id\", \"" + this.meta.name + "hovertri\"); newTri.setAttributeNS(null, \"points\", (" + this.x + " + nodeRadius + 5) + \",\" + " + this.y + " + \" \" + (" + this.x + " + nodeRadius + 5 + 20) + \",\" + " + this.y + " + \" \" + (" + this.x + " + nodeRadius + 5 + 20) + \",\" + (" + this.y + " + 20)); newTri.setAttributeNS(null, \"fill\", \"white\"); newTri.setAttributeNS(null, \"stroke\", \"black\"); /* change to none when backgrounds implemented */ svg.appendChild(newTri); var newRect = document.createElementNS(\"http://www.w3.org/2000/svg\", \"rect\"); newRect.setAttributeNS(null, \"id\", \"" + this.meta.name + "hoverrect\"); newRect.setAttributeNS(null, \"x\", \"\" + (" + this.x + " + nodeRadius + 5 + 20)); newRect.setAttributeNS(null, \"y\", \"\" + " + this.y + "); newRect.setAttributeNS(null, \"height\", \"100\"); newRect.setAttributeNS(null, \"width\", \"200\"); newRect.setAttributeNS(null, \"fill\", \"white\"); newRect.setAttributeNS(null, \"stroke\", \"black\"); /* change to none when background implemented*/ svg.appendChild(newRect);var title = document.createElementNS(\"http://www.w3.org/2000/svg\", \"text\");title.setAttributeNS(null, \"id\", \"" + this.meta.name + "hovertitle\");title.setAttributeNS(null, \"x\", \"\" + " + this.x + " + nodeRadius + 5 + 20);title.setAttributeNS(null, \"y\", \"\"" + this.y + " + 20);title.setAttributeNS(null, \"style\", \"font-size: 20px;\");title.setAttributeNS(null, \"fill\", \"black\");title.textContent = \"" + this.meta.name + "\";svg.appendChild(title);var dateline = document.createElementNS(\"http://www.w3.org/2000/svg\", \"text\");dateline.setAttributeNS(null, \"id\", \"" + this.meta.name + "hoverbyline\");title.setAttributeNS(null, \"x\", \"\" + " + this.x + " + nodeRadius + 5 + 20);title.setAttributeNS(null, \"y\", \"\"" + this.y + " + 30);dateline.setAttributeNS(null, \"style\", \"font-size: 10px;\");dateline.setAttributeNS(null, \"fill\", \"grey\");dateline.textContent = \"Created " + this.meta.date + ", by " + this.meta.by + "\";svg.appendChild(dateline);var desc = document.createElementNS(\"http://www.w3.org/2000/svg\", \"text\");desc.setAttributeNS(null, \"id\", \"" + this.meta.name + "hoverdesc\");title.setAttributeNS(null, \"x\", \"\" + " + this.x + " + nodeRadius + 5 + 20);title.setAttributeNS(null, \"y\", \"\"" + this.y + " + 42);desc.setAttributeNS(null, \"style\", \"font-size: 12px;\");desc.setAttributeNS(null, \"fill\", \"black\");desc.textContent = \"" + this.meta.desc + "\";svg.appendChild(desc);svg.appendChild(newRect);")));
