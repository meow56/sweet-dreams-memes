...
function Node(metadata, official) {
  ...
  this.display = function(nodes, i) {
    ...
    newCircle.addEventListener("mouseoff", new Function("svg.removeChild(document.getElementById(\"" + this.meta.name + "hovertri\"));svg.removeChild(document.getElementById(\"" + this.meta.name + "hoverrect\"));"));
    svg.appendChild(newCircle);
  }
}
