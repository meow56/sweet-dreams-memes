...
function Node(metadata, official) {
  ...
  this.display = function(nodes, i) {
    ...
    newCircle.addEventListener("mouseout", new Function("document.getElementsByTagName(\"svg\")[0].removeChild(document.getElementById(\"" + this.meta.name + "hovertri\")); document.getElementsByTagName(\"svg\")[0].removeChild(document.getElementById(\"" + this.meta.name + "hoverrect\"));"));
    svg.appendChild(newCircle);
  }
}
