...
function Node(metadata, official) {
  ...
  this.display = function(nodes, i) {
    ...
    newCircle.addEventListener("mouseout", new Function("svg.removeChild(document.getElementById(\"" + this.meta.name + "hovertri\"));svg.removeChild(document.getElementById(\"" + this.meta.name + "hoverrect\"));"));
    svg.appendChild(newCircle);
  }
}
